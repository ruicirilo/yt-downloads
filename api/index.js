...
app.use(express.static(path.join(__dirname, '..', 'public'))); // Ajuste o caminho para a pasta public

app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, '..', 'public', 'index.html')); // Ajuste o caminho para o index.html
});
